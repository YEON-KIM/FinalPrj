...
<main class="form-signin w-100 m-auto">
    <form action="${root}/admin/member/login" method="POST" >
        <img class="mb-4" src="${root}/resources/img/logo2.png" alt="" width="300" height="131">
        ...
        <button class="w-100 btn btn-lg btn-primarylogin" type="submit">로그인</button>
